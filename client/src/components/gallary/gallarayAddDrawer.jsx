    ...
    return (
        <>
            <Flex bg="gray" align="center" cursor="pointer" _hover={{ shadow: "dark-lg" }} onClick={onOpen} >
                ...
                <Center marginLeft="5">
                    <Text fontSize="3xl" fontWeight="bold">Gallary</Text>
                </Center>
            </Flex>
            <Drawer
                size="md"
                    ...
                    <DrawerOverlay>
                        <DrawerContent>
                            ...
                            <DrawerBody>
                                <Stack spacing="24px">
                                    <Box marginTop="5">
                                        <Input type="file" onChange={(e) => {content.file = e.target.files[0]}}></Input>
                                    </Box>
                                    <Button onClick={imageUpload} color="blue.500" >Upload</Button>
