...
import { Box, Button, Divider, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, Flex, FormLabel, Icon, IconButton, Image, Input, SimpleGrid, Stack, Text, Textarea, useDisclosure, useToast } from "@chakra-ui/react";
        ...
        <Box maxH="75vh" overflowY="scroll" overflowX="hidden">
          <Flex direction="column" padding="10">
            <Flex>
              ...
              <IconButton marginLeft={5} onClick={handleDelete}  icon={<DeleteIcon color="red" w={10} h={10} />} />
            </Flex>
